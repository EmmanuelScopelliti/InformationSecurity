...
(require __DIR__.'/Shopware_Core_KernelDevDebugContainer.php')->set(\Container8rXWesy\Shopware_Core_KernelDevDebugContainer::class, null);
...
$classes[] = 'LoginVulnerabilities\Controller\Decorators\LoginRouteDecorator';
