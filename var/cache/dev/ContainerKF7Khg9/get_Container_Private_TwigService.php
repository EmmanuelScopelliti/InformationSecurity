 ...
 */
class get_Container_Private_TwigService extends Shopware_Core_Installer_InstallerKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).'/vendor/shopware/core/Installer/Resources/views'), 'Installer');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/shopware/core/Installer/Resources/views'), '!Installer');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/symfony/twig-bridge/Resources/views/Email'), 'email');
        $a->addPath((\dirname(__DIR__, 4).'/vendor/symfony/twig-bridge/Resources/views/Email'), '!email');

        $container->services['.container.private.twig'] = $instance = new \Twig\Environment($a, ['debug' => true, 'strict_variables' => false, 'autoescape' => 'name', 'cache' => ($container->targetDir.''.'/twig'), 'charset' => 'UTF-8']);
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\AssetExtension(new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\EmptyVersionStrategy(), new \Symfony\Component\Asset\Context\RequestStackContext($c, $d->getBaseUrl(), $d->isSecure())), new RewindableGenerator(function () use ($container) {
            yield 'asset' => ($container->privates['shopware.asset.asset'] ?? $container->load('getShopware_Asset_AssetService'));
        }, 1))));
