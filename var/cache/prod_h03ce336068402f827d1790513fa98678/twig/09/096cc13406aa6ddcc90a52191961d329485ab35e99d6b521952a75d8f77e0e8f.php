...
class __TwigTemplate_2b91b6ebca394c088ed59370054cd9b7 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_base_flashbags($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable(sw_get_attribute($this->env, $this->source, ($context["app"] ?? null), "flashes", [0 => [0 => "warning", 1 => "error", 2 => "danger"]], "method", false, false, false, 5));
        $context['loop'] = [
...
";
    ...
    {
        return new Source("", "@Storefront/storefront/page/error/_page.html.twig", "/var/www/html/InformationSecurity/vendor/shopware/storefront/Resources/views/storefront/page/error/_page.html.twig");
    }
}
